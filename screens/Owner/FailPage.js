...
export default ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
        <Text style={styles.title}>실패 입니다. <Text style={{color:"black"}}>공유 음식점</Text>이 될 수 있나요?</Text>
        ...
        <View style={styles.buttonBox}>
          ...
          <TouchableWithoutFeedback style={{alignItems:"center"}} onPress={() => navigation.navigate("공유 음식점 신청")}>
            <View style={styles.button}>
